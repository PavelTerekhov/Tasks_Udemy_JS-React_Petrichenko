...
// Task 13. Продвинутая задача на работу с объектами и массивами
...
// Task 14. Продвинутая задача на работу с объектами и массивами
...
// Task 15. Задания на поиск ошибок в коде
...
function factorial(n) {
    if (typeof(n) != "number" || Math.ceil(n) != n) {
        return "error";
    }
    else if (n <= 0) {
   return 1;
